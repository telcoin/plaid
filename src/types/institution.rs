...
pub struct Institution {
    ...
    payment_initiation_metadata: Option<PaymentInitiationMetadata>,
...
pub struct InstitutionStatus {
    ...
    item_logins: RequestStatus,
    /// A representation of the status health of a request type. Auth requests, Balance requests,
    /// Identity requests, Investments requests, Liabilities requests, Transactions updates,
    /// Investments updates, Liabilities updates, and Item logins each have their own status object.
    transactions_updates: RequestStatus,
    /// A representation of the status health of a request type. Auth requests, Balance requests,
    /// Identity requests, Investments requests, Liabilities requests, Transactions updates,
    /// Investments updates, Liabilities updates, and Item logins each have their own status object.
    auth: RequestStatus,
    ...
    /// Identity requests, Investments requests, Liabilities requests, Transactions updates,
    /// Investments updates, Liabilities updates, and Item logins each have their own status object.
    investment_update: RequestStatus,
    /// A representation of the status health of a request type. Auth requests, Balance requests,
    /// Identity requests, Investments requests, Liabilities requests, Transactions updates,
    /// Investments updates, Liabilities updates, and Item logins each have their own status object.
    liabilities_updates: RequestStatus,
    /// A representation of the status health of a request type. Auth requests, Balance requests,
    /// Identity requests, Investments requests, Liabilities requests, Transactions updates,
    /// Investments updates, Liabilities updates, and Item logins each have their own status object.
    liabilities: RequestStatus,
    /// A representation of the status health of a request type. Auth requests, Balance requests,
    /// Identity requests, Investments requests, Liabilities requests, Transactions updates,
    /// Investments updates, Liabilities updates, and Item logins each have their own status object.
    investments: RequestStatus,
    /// Details of recent health incidents associated with the institution.
    health_incidents: Option<Vec<HealthIncident>>,
}
...
pub struct PaymentInitiationMetadata {
    ...
    ///
    /// Example: {"GBP": "10000"}
    maximum_payment_amount: HashMap<String, String>,
    ...
    /// the institution.
    standing_order_metadata: Option<StandingOrderMetadata>,
}
...
pub struct StandingOrderMetadata {
    ...
    ///
    /// Min length: 1
    valid_standing_order_intervals: Vec<String>,
}
...
pub struct AuthMetadata {
    ...
    supported_methods: Option<SupportedMethods>,
}
